          ...
          <v-list>
                ...
                <div class="titleSearch">
                  <div >
                    ...
                    <div v-else style="margin-top: 30px;">
                      <div class="titleStyleBase titleStyleAnother" v-for="(item, index) in title" :key="index">
                        {{ item }}
                      </div>
                    </div>
                  </div>
                  <v-text-field ref="searchInput" class="singleInputStyle" style="font-size: 20px; margin: 10px 20px 0 22px;" 
              ...
              <v-flex lg12 xs12 sm12 md12 pt-0 pb-0 v-if="type === 'text' && Questions && attribute.length > 0">
                <div :class="attribute.length > 4 ? 'scrollMultiQuestionMore' : 'scrollMultiQuestionInput'">
                  <v-layout row v-for="(item, index) in attribute" :key="index" style="margin-top: 1px">
                    <div class="multiQuestionName" :style="{ fontSize: '20px', margin: '5px 24px 0px 38px', width: `${maxQuestionWidth}px` }">
                      {{ item.question }}
                    </div>
                ...
                <div :class="attribute.length > 4 ? 'submitButtonMore' : 'submitButtonInput'">
            ...
            <v-flex lg12 xs12 sm12 md12 pt-0 pb-0 v-if="type === 'select' && !Questions" style="margin-bottom: 36px">
              <v-layout row>
                ...
                <div>
                  ...
                  <div v-else>
                    <div class="titleStyleBase titleSelectStyle" v-for="(item, index) in title" :key="index">
                        {{ item }}
                    </div>
                  </div>
                </div>
                <v-select ref="singleSelect" class="singleSelectStyle" :items="options"
                  style="font-size: 20px; margin: 13px 36px 10px 36px" outline clearable solo :multiple="multiple"
            ...
            <div class="multiQuestion">
              <v-flex lg12 xs12 sm12 md12 pt-0 pb-0 v-if="type === 'select' && Questions">
                <div :class="attribute.length > 4 ? 'scrollMultiQuestionMore' : 'scrollMultiQuestion'">
                  <v-layout row v-for="(item, index) in attribute" :key="index" style="margin-top: 1px">
                    <div class="multiQuestionName" :style="{ fontSize: '20px', margin: '5px 24px 0px 38px', width: `${maxQuestionWidth}px` }">
                      {{ item.question }}
                    </div>
                ...
                <div :class="attribute.length > 4 ? 'submitButtonMore' : 'submitButton'">
...
export default {
  ...
  data() {
    return {
      ...
      arrTitle: [],
      matchSingleSelect: [],
      scrollDistance: 0, // 用于记录当前的滚动距离
      maxScrollDistance: 50, // 设置最大滚动距离
    };
  },
  computed: {
    openQuestion() {     
  ...
  methods: {
    ...
    calculateMaxWidth() {
      ...
      if (width.length > 0) {
        ...
        this.maxQuestionWidth = max > 800 ? max - 35 : max + 6;
      }
    },
    setupResizeObserver() {
...
.inputStyle {
  font-size: 20px;
  margin: 0 36px 0px 0px !important;
}
