        ...
        <v-flex lg12 xs12 sm12 md12>
          <v-list>
            ...
            <v-flex lg12 xs12 sm12 md12 mt-0 pb-0 v-if="image">
              <div style="display: flex; cursor: zoom-in">
            ...
            <div class="multiQuestion">
              <v-flex lg12 xs12 sm12 md12 pt-0 pb-0 v-if="type === 'text' && Questions && attribute.length > 0">
                <div class="scrollMultiQuestion">
                  <v-layout row v-for="(item, index) in attribute" :key="index" style="margin-top: 1px">
                    <div class="multiQuestionName" :style="{ fontSize: '20px', margin: '3px 8px 0px 19px', width: `${maxQuestionWidth}px` }">
                      {{ item.question }}
                    </div>
                    <v-text-field :ref="`searchInput${index}`" class="inputStyle" :type="textTypes[index]"
            ...
            <v-flex lg12 xs12 sm12 md12 pt-0 pb-0 v-if="type === 'select' && !Questions" style="margin-bottom: 36px">
              <v-layout row>
                <div class="titleSearch">
                <div>
            ...
            <div class="multiQuestion">
              <v-flex lg12 xs12 sm12 md12 pt-0 pb-0 v-if="type === 'select' && Questions">
                <div class="scrollMultiQuestion">
                  <v-layout row v-for="(item, index) in attribute" :key="index" style="margin-top: 1px">
                    <div class="multiQuestionName" :style="{ fontSize: '20px', margin: '3px 2px 0px 19px', width: `${maxQuestionWidth}px` }">
                      {{ item.question }}
                    </div>
                    <v-select :ref="`multiSelect${index}`" class="inputStyle" v-bind:key="index"
                      ...
                      @blur="handleMultiSelect(index)" @focus="handleSelectRules(index)">
